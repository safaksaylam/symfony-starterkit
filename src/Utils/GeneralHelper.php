...
class GeneralHelper
{
     ...
     * @throws \Exception
     */
    public function randomString(int $length, string $alphabet = '0123456789ABCDEFGHIJKLMNOPRSTUVYZ'): string
    {
        $str = '';
     ...
     * @return string
     */
    public function makeSlug(string $string, array $options = []): string
    {
